...
public class BasketBallMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_basketball);
    ...
    public void threePointerForTeam1(View view) {
    ...
    public void threePointerForTeam2(View view) {
